...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <% clsConnection c=new clsConnection();
       ...
       {
           queryPro = "select * from Tbl_Products where ProductId = '" + Request.QueryString["pid"].ToString() + "'";
           dsP = c.SelectDS(queryPro);
       } %>
			...
			<div class="single-page">
				<div class="single-page-row" id="detail-21">
					...
					<div class="col-md-6 single-top-right">
						<h3 class="item_name"><%= dsP.Tables[0].Rows[0]["ProductName"] %></h3>
						<p><%= dsP.Tables[0].Rows[0]["Description"] %> </p>
						...
						<div class="single-price">
							<ul>
								<li><%= dsP.Tables[0].Rows[0]["SellingPrice"] %> INR</li>  
								<li><del><%= dsP.Tables[0].Rows[0]["Price"] %> INR</del></li> 
								<li><span class="w3off">10% OFF</span></li> 
								<li>Ends on: June,5th</li>
								<li><a href="#"><i class="fa fa-gift" aria-hidden="true"></i> Coupon</a></li>
							</ul>	
						</div> 
						<p class="single-price-text"><%= dsP.Tables[0].Rows[0]["Description"] %></p>
